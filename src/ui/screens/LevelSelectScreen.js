javascript:LevelSelectScreen.js:LevelSelectScreen.js import { UIRouter } from '../UIRouter.js'; import { GameState } from '../../state/gameState.js'; import thresholds from '../../data/thresholdsData.js'; // 🔧 New System Import: Authored Level Definitions import scoutLevel from '../../engine/level/definitions/scout_threshold_01.js';

// Map tiers to Runes (Visual only, as they aren't in the data file yet) const TIER_RUNES = ['👁', '⚔', '👣', '🔮', '⚛'];

// Map of Authored Levels: Tier Index -> { Sequence Order -> Level Definition } const AUTHORED_LEVELS = { 0: { // Scout (Index 0) 1: scoutLevel } };
            ...
            <button class="tier-btn ritual-card ${isActive ? 'active tier-glow' : ''}"
                ...
                <div class="card-inner">
                    <div class="card-header">
                        ...
                        <span class="tier-mult">×${t.multiplier.toFixed(1)}</span>
                    </div>
                    <div class="card-body">
                        <p class="flavor-text">"${t.flavor.description || t.flavor}"</p>
